    ...
    <div className="mx-auto max-w-5xl px-6 py-16">
      ...
      <div className="mb-12">
        <div className="mb-2 flex items-center gap-3">
          ...
          <span className="badge bg-amber-500/20 text-amber-300">Preview Mode</span>
        </div>
      ...
      <div className="mb-8 grid gap-4 md:grid-cols-3">
        <div className="card-surface">
          ...
          <div className="mt-1 text-lg font-semibold text-emerald-400">Running</div>
        </div>
        <div className="card-surface">
        ...
        <div className="card-surface">
          ...
          <div className="mt-1 text-lg font-semibold text-brand-400">Enabled</div>
        </div>
      </div>
      ...
      <div className="card-surface flex min-h-[400px] flex-col items-center justify-center">
        ...
        <p className="mt-2 max-w-md text-center text-sm text-white/40">
          Sandboxed preview will render here. Changes are applied in preview mode first,
          then published with explicit approval.
        </p>
      ...
      <div className="mt-8 rounded-lg border border-amber-500/20 bg-amber-500/5 p-4">
        <p className="text-sm text-amber-300/80">
          <span className="font-semibold">Scope Escalation Guardrail:</span> Any request to
          access filesystem paths outside the designated sandbox directory requires explicit
          human approval.
        </p>
      </div>
    </div>
